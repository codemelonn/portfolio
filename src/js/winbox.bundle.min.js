 ...
 self.max &&*/
    ...
    function W(a, b) {
            ...
            a.min ||
                ...
                (p = g.touches) && (p = p[0])
                    ? ((g = p),
                      ...
                      k(window, "touchend", d, m))
                    : (k(window, "mousemove", f, m),
        ...
        function f(g) {
            ...
            H &&
                ((a.width = Math.max(
                    Math.min(a.width, a.m, K - a.x - a.right),
                    a.s
                )),
                (H = a.width !== C));
            I &&
    ...
    e.move = function (a, b, c) {
        a || 0 === a
            ? c ||
              ((this.x = a
                  ? (a = V(a, K - this.left - this.right, this.width))
                  : 0),
              (this.y = b
                  ? (b = V(b, P - this.top - this.bottom, this.height))
                  : 0))
            : ((a = this.x), (b = this.y));
        u(this.g, "left", a + "px");
        u(this.g, "top", b + "px");
